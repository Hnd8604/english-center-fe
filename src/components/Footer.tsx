        ...
        <footer className="bg-gray-900 text-white py-8">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-lg font-semibold mb-4">English Center</h3>
                        <p className="text-gray-400">
                            Trung tâm Anh ngữ hàng đầu với hơn 10 năm kinh nghiệm đào tạo
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="/courses" className="text-gray-400 hover:text-white">Khóa Học</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            ...
                            <li>Tel: (028) 1234 5678</li>
                            <li>Email: info@englishcenter.com</li>
                        </ul>
                    </div>
